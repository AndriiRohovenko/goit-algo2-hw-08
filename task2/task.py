...
class SlidingWindowRateLimiter:
    ...
    def time_until_next_allowed(self, user_id: str) -> float:
        ...
        # Час, коли буде дозволено наступне повідомлення
        next_allowed_time = self.user_requests[user_id][0] + self.window_size
        return max(0, next_allowed_time - current_time)
